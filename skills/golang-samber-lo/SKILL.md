...
For detailed package comparison and decision flowchart, see [Package Guide](package-guide.md).
...
For the complete function catalog (300+ functions), see [API Reference](AI/skills/golang-samber-lo/references/api-reference.md).

For composition patterns, stdlib interop, and iterator pipelines, see [Advanced Patterns](advanced-patterns.md).
