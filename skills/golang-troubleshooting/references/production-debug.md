...
Capture all profiles before restarting the process. Use the curl commands from [pprof.md](AI/skills/golang-troubleshooting/references/pprof.md), targeting your production server address. At minimum, capture: goroutine dump (`?debug=2`), heap, CPU (30s), and mutex profiles.
...
Download the captured `.prof` files and analyze with `go tool pprof` (see [pprof.md](AI/skills/golang-troubleshooting/references/pprof.md)).
