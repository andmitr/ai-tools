...
Use pprof goroutine profile (see [pprof.md](AI/skills/golang-troubleshooting/references/pprof.md)) with `?debug=2` for human-readable output, then look for goroutines stuck in `chan receive`.
