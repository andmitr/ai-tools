...
For an introduction to functional programming concepts and why monads are valuable in Go, see [Monads Guide](monads-guide.md).
...
For full API reference, see [Option Reference](option.md).
...
For full API reference, see [Result Reference](result.md).
...
For full API reference, see [Either Reference](either.md).
...
For detailed pipeline API reference, see [Pipelines Reference](AI/skills/golang-samber-mo/references/pipelines.md).
...
For advanced types (Future, IO, Task, State), see [Advanced Types Reference](advanced-types.md).
