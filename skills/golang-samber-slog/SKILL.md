...
For full code examples of every pattern, see [Pipeline Patterns](pipeline-patterns.md).
...
For strategy comparison and configuration details, see [Sampling Strategies](sampling-strategies.md).
...
For framework-specific setup, see [HTTP Middlewares](http-middlewares.md).
...
For configuration examples and shutdown patterns, see [Backend Handlers](backend-handlers.md).
