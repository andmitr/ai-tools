...
- **[Testing Database Code](AI/skills/golang-database/references/testing.md)** — Mock connections, integration tests with containers, fixtures, schema setup/teardown
