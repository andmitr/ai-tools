...
For Decorate, Scopes, optional deps, error helpers, and Visualize, see [advanced.md](AI/skills/golang-uber-dig/references/advanced.md).
...
dig containers are cheap — build a fresh one per test, override providers with `Decorate`, and call `Invoke` to drive the system. For full patterns (per-test wiring, shared helpers, graph validation in CI, asserting wire-time errors, recovering from constructor panics), see [testing.md](AI/skills/golang-uber-dig/references/testing.md).

## Further Reading

- [advanced.md](AI/skills/golang-uber-dig/references/advanced.md) — Decorate, Scopes, optional deps, error helpers, Visualize, full Quick Reference
- [recipes.md](AI/skills/golang-uber-dig/references/recipes.md) — end-to-end examples: HTTP server with route group, two databases, request scopes, decorators, dry-run validation
- [testing.md](AI/skills/golang-uber-dig/references/testing.md) — testing patterns and graph validation
