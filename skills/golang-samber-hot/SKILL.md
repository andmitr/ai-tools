...
For detailed algorithm comparison, benchmarks, and a decision tree, see [Algorithm Guide](algorithm-guide.md).
...
For advanced patterns (revalidation, sharding, missing cache, monitoring setup), see [Production Patterns](production-patterns.md).

For the complete API surface, see [API Reference](AI/skills/golang-samber-hot/references/api-reference.md).
