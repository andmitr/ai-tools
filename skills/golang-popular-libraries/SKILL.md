...
- [Standard Library - New & Experimental](stdlib.md) — v2 packages, promoted x/exp packages, golang.org/x extensions
- [Libraries by Category](libraries.md) — vetted third-party libraries for web, database, testing, logging, messaging, and more
- [Development Tools](AI/skills/golang-popular-libraries/references/tools.md) — debugging, linting, testing, and dependency management tools
