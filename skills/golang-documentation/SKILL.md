...
README SHOULD follow this exact section order. Copy the template from [templates/README.md](README.md):
...
**Changelog** — Track changes using [Keep a Changelog](https://keepachangelog.com/) format or GitHub Releases. Copy the template from [templates/CHANGELOG.md](CHANGELOG.md). See [Project Docs](project-docs.md#changelog).
...
- **llms.txt** — add a `llms.txt` file at the repository root. Copy the template from [templates/llms.txt](llms.txt). This file gives LLMs a structured overview of your project.
